          ...
          <div className="container">
            <div className="about-sec-main concierge-page">
              ...
              <img src="images/conciergeservices.jpg" alt="eco ambassador" />
                ...
                <h4> Dont miss out on the stunning New Christian Louboutin make up range.</h4>	
...
<ul className="eco_ul p-b-20">
                <li><i className="fa fa-dot-circle-o" /> <span>On-demand shopping from Central London areas with a £10 delivery charge*.</span></li>
...
<li>  -   For additional shopping a second charge of £10 will apply</li>
