...
import { juniorEcoAmbassador } from '../../actions/common';
...
class Contactus extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.juniorEcoAmbassadorData) {
      this.setState({
        name: '',
        email: '',
        phone_number: '',
      ...
      <div>
        <section className=" content-sec">{/*OPEN slider-sec */}
          <div className="container">
            <h2 className="inner-title">Become A Junior Eco Ambassador</h2>
          </div>
              ...
              <div className="contact-col-left">
                <form onSubmit={this.handleSubmit}>
                  ...
                  Register Junior Eco Ambassador
                    ...
                    <input autoComplete="off" required className="form-control" type="text" name="name" placeholder="Parent/guardian Name" onChange={this.handleInputChange} value={this.state.name} />
...
const mapDispatchToProps = (dispatch) => {
  return {
    juniorEcoAmbassador: bindActionCreators(juniorEcoAmbassador, dispatch)
  }
}
function mapStateToProps(state) {
  return {
    juniorEcoAmbassadorData: state.common.junierecoambassador,
  };
}
